<template>
  <div class="table">
    <div class="table-label">
      ...
      ></i>
      <span
        style="font-size: 16px;height: 30px;line-height: 30px;font-weight: bold;"
        class="comTitle"
      >交易扣款审核</span>
    </div>
    ...
    <div class="handle-box top-select-box clear">
      <div class="top">
        <span>交易时间:</span>
        <el-date-picker type="date" v-model="startTime" placeholder="起始时间" style="width: 18%"></el-date-picker>
        <span>-</span>
        <el-date-picker type="date" v-model="endTime" placeholder="终止时间" style="width: 18%"></el-date-picker>
        ...
        <el-button size="mini" type="success" class="searchBtn" @click="handleData">
          <i class="el-icon-upload2"></i>批量审核
        </el-button>
      </div>
    </div>
